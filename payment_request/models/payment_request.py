...
class PaymentRequest(models.Model):
    ...
    account_id = fields.Many2one('account.account', string='Account',required=True, related='company_id.custody_account_id',
    ...
    def _onchange_employee_id(self):
        ...
        prev_custody = self.env['payment.request'].search([('employee_id','=',self.employee_id.id),('state','=','paid')],limit=1)
        if prev_custody:
