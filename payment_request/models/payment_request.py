...
class PaymentRequest(models.Model):
    ...
    journal_id = fields.Many2one('account.journal', string='Journal', required=False, readonly=False, )
    ...
    is_renewable = fields.Boolean(string='Is Renewable', tracking=True)
    ...
    state = fields.Selection([
        ('draft', 'Draft'),
        ('submit', 'Submit'),
        ('wait_department_manager', 'Waiting Department Manager'),
        ('wait_financial_manager', 'Waiting Financial Manager'),
        ('wait_auditing', 'Waiting Auditing'),
        ('wait_gm', 'Waiting GM'),
        ('approve', 'Approved'),
    ...
    amount_untaxed = fields.Monetary(string='Untaxed Amount', store=True, readonly=True, compute='_amount_all',
                                     tracking=5)
    total_amount = fields.Float('Total ', compute='_amount_all', store=True)
    ...
    def action_submit(self):
        ...
        self.write({'state': 'wait_department_manager'})
