# -*- coding: utf-8 -*-
{
    ...
    'summary': 'عرض الفواتير في فترة معينة بالمنتجات وتفاصيلها والإجمالي، '
               'وعرض المبيعات مع الدفعات المرتبطة بها',
    'description': """
...
تقرير المبيعات مع الدفعات المرتبطة (جديد)
==========================================
- عرض فواتير المبيعات في الفترة المحددة
- عرض كل دفعة مرتبطة بكل فاتورة: نوع الدفعية (كاش / بنك)،
  قيمة السداد، رقم الإشعار (سند الدفع)
- عرض رقم أمر البيع المصدر لكل فاتورة
    """,
    ...
    'data': [
        ...
        'views/invoice_payment_report_view.xml',
