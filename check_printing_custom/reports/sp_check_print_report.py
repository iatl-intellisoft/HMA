...
class CheckPrintingSpecial(models.AbstractModel):
    _name = 'report.check_printing_custom.sp_check_print_template'
    ...
    def _get_report_values(self, docids, data=None):
        ...
        if lang_dir == 'rtl':
            return {
                ...
                'ac_payee_y': str(check_dimension_id.ac_payee_y) + str(dimension_type),
                'ac_payee_x': str(-check_dimension_id.ac_payee_x) + str(dimension_type),
