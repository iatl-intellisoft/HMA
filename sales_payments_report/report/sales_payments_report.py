...
class SalesPaymentsReport(models.Model):
    """تقرير قراءة فقط (مبني على SQL View) يربط كل فاتورة مبيعات
    بكل دفعة مسددة عليها فعليًا عن طريق قيود التسوية
    (account.partial.reconcile)."""

    _name = 'sales.payments.report'
