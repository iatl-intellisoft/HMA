...
class Users(models.Model):
    ...
    department_id = fields.Many2one('hr.department', string='Department', related=False, company_dependent=True)
    allowed_department_ids = fields.Many2many('hr.department', 'rdepartment_users_rel', 'uid', 'department_id',
